...
module.exports = async (client) => {
  ...
  client.playembed = (guild) => {
    let embed = new EmbedBuilder()
      ...
      .setAuthor({
        name: `Toco a musica que vc quiser! é só digitar o nome ou o link dela , é so vc entrar em algum canl de voz ok?😉`,
    ...
    queueembed.edit({
      embeds: [
        new EmbedBuilder()
          .setColor(client.config.embed.color)
          .setAuthor({
            name: `Dj_Akira Queue  -  [ ${queue.songs.length} Tracks ]`,
            iconURL: guild.iconURL({ dynamic: true }),
          })
